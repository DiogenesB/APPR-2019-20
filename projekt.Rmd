...
2. `produkti` - podatki o vseh izdelkih na platformi
  ...
  - `dolsfsdina` - meritev: dolžina izdelka (cm)
...
```{r shiny ui, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
source("shiny/ui.r", encoding = "UTF-8")
```

```{r shiny server, echo=FALSE, message=FALSE, warning=FALSE, results='hide'}
